...
def run_dcrnn(args):
    with open(args.config_filename) as f:
        ...
        supervisor = DCRNNSupervisor(
            random_seed=int(args.random_seed), adj_mx=adj_mx, **supervisor_config
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config_filename",
        default="data/model/pretrained/COV-19/config.yaml",
        type=str,
        help="Config file for pretrained model.",
    )
    parser.add_argument(
        "--output_filename",
        default="data/alltest_deepgleam_point_week33_seed1_epo69.npz",
    )
